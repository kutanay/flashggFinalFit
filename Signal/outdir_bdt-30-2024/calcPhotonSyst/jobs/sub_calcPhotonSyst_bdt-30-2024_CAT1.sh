...
python3 /eos/home-t/takumar/gitcode/higgsdna_finalfits_tutorial_24/07_FinalFits/CMSSW_14_1_0_pre4/src/flashggFinalFit/Signal/scripts/calcPhotonSyst.py --cat CAT1 --procs ma30 --ext bdt-30-2024 --inputWSDir /eos/home-t/takumar/gitcode/higgsdna_finalfits_tutorial_24/07_FinalFits/CMSSW_14_1_0_pre4/src/flashggFinalFit/Trees2WS/inputs/2024/30_GeV/forws/ws_ma30 --scales 'ScaleIJaZ,FNUF,Material' --scalesCorr '' --scalesGlobal 'NonLinearity,Geant4' --smears 'SmearingIJaZ' 
